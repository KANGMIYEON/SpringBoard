...
public class CommentController {
	...
	// produces : 값을 보낼 때의 형태 {MediaType.TEXT_PLAIN_VALUE} - http로 import
	...
	public ResponseEntity<List<CommentVO>> spread(@PathVariable("bno") int bno){ // path 에서 달고 온 value 의 bno
